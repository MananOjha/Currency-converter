...
public class Currency {
	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("IND", 83.26);
				break;
			case "Euro":
				...
				this.exchangeValues.put("IND", 90.45);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("IND", 105.87);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("IND", 91.45);
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("IND", 11.51);
				break;
			case "Japanese Yen":
				...
				this.exchangeValues.put("IND", 0.53);
				break;
			case "IND Rupee":
				...
				this.exchangeValues.put("JPY", 1.88);
				this.exchangeValues.put("IND", 1.00);
			break;
		}
	}
	...
	public static ArrayList<Currency> init() {
		...
		currencies.add( new Currency("IND Rupee", "IND") );
